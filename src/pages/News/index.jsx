    ...
    <>
      <div className="main-content">
        <Link to="/news/1" className="main-content-item d-flex">
          ...
          <div className="info">
            ...
            <div className="info-date d-flex">
              ...
              <div className="info-date-time">01/01/2025</div>
            </div>
        ...
        <Link to="/news/1" className="main-content-item d-flex">
          ...
          <div className="info">
            ...
            <div className="info-date d-flex">
              ...
              <div className="info-date-time">02/01/2025</div>
            </div>
            <p className="info-content">
        ...
        <Link to="/news/1" className="main-content-item d-flex">
          ...
          <div className="info">
            <h3 className="info-name">
              Khai trương cơ sở Nguyễn Xiển, giảm giá lên tới 50%
            </h3>
            <div className="info-date d-flex">
              <div className="info-date-icon">
                <FaCalendarAlt />
            ...
            <p className="info-content">
              Nhân dịp khai trương cơ sở mới tạiĐ. Nghiêm Xuân Yêm, Đại Kim, Hoàng Mai, Hà Nội 100000, Việt Nam,
                  ...
                  <Link to="/news/1" className="side-news-item d-flex">
                    ...
                    <div className="info">
                      ...
                      <div className="info-date d-flex">
                        ...
                        <div className="info-date-time">04/01/2025</div>
                      </div>
                    </div>
                  </Link>
                  <Link to="/news/1" className="side-news-item d-flex">
                    ...
                    <div className="info">
                      ...
                      <div className="info-date d-flex">
                        ...
                        <div className="info-date-time">03/01/2025</div>
                      </div>
                    </div>
                  </Link>
                  <Link to="/news/1" className="side-news-item d-flex">
